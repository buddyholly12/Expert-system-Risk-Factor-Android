...
class Medium_Checker : AppCompatActivity(), AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private fun Cf_data(){
        ...
        val arrayAdapter = ArrayAdapter(this@Medium_Checker,android.R.layout.simple_spinner_dropdown_item,Cf_datauser)
    ...
    private fun SmokeBackwardMed(qty:String):String {
        if (qty.isEmpty())
        {
            val Intent = Intent(this@Medium_Checker, Res_test::class.java)
            ...
            val alertnotifDialog = AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK"){ _,_->
                    val Intent = Intent(this@Medium_Checker, homeUI::class.java)
                    startActivity(Intent)
                }
                .create()
